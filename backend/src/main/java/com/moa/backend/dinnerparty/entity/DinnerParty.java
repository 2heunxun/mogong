...
@Entity
@Table(name = "dinner_party")
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class DinnerParty extends BaseTimeEntity {
    ...
    public void update(String title, String description, String location, LocalDateTime meetingAt,
                        Integer capacity, String openChatUrl) {
        this.title = title;
        this.description = description;
        this.location = location;
    ...
    public void validateOwner(Long userId) {
        if (!isOwner(userId)) {
            throw new BusinessException(ErrorCode.NOT_DINNER_PARTY_OWNER);
        }
    }
