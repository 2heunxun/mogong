...
@Schema(description = "승인된(APPROVED) 저녁팟 파티원 한 명의 정보")
public record DinnerPartyMemberResponse(
    ...
    public static DinnerPartyMemberResponse of(DinnerPartyMember member, Long ownerId) {
        return new DinnerPartyMemberResponse(
